...
export const Container = styled.div`
   ...
   border: ${({ theme, isnew }) => isnew == 'true' ? `1px dashed ${theme.COLORS.PLACEHOLDER_INPUT_COLOR}`  : "none"};
   border-width: 2px; 

   background-color: ${({ theme, isnew }) => isnew == 'true' ? "transparent" : theme.COLORS.MEDIUM_GRAY};
   border-radius: 8px;
   padding: 0rem .7rem;
